    ...
    for (var _i2 = 0, _Object$entries2 = Object.entries(checkPreferencesFromStorage); _i2 < _Object$entries2.length; _i2++) {
      ...
      if (k != 'necessary') {
        ...
        if (getGoogleAnalytics) {
          ...
          var getAttribute = getGoogleAnalytics.getAttribute('data-jgc-tag');
